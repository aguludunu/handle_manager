...
**
** Generated on 2024-05-23 14:15:40 UTC from these sources:
**
** 26069b4ae2089ab52c5636cead5ac3fa2c2e3426  carray.c
** abab2aa114ed49b15d837a0732385505475a03e6  carray.h
** 8efaf01c6a89dd3f9e4f21b308fbe890432c295e  fts5_test_mi.c
** f189ff6d1bbefedb6e7167ae3b603d041d97e816  mkdevkit.tcl
** 2b44dc373282ba816c0df8e32aee468351548221  nextchar.c
** 1246cbf60549ec47bcd35865678f89e28d3d9dfc  rbu.c
** f7dfdcfdaa776ad2eacd6f3a27673828b43a011f  shathree.c
** 462127c51240d74dda8bd7dee6922ccd21e076ae  shell.c
** bff6093bb3e0f75f60d3c3fc1a5ad2f23e660758  spaceanal.tcl
** b53665b2594389c1533537da5d601668253e04d8  spellfix.c
** c3e2612b6e1ea217215749663bbbf4a7a0135ded  sqlite3.c
** 179727629dc989066b74f9cee621f9fded7a2948  sqlite3.h
** b5f518e0f4ee9f67c064189b9f5bab832ebed375  sqlite3ext.h
** 60e8d70821a346eb99027f29b120da8f6c73d884  sqlite3rbu.h
** 13161e8cb7f7eb758a8b31696c1ca9f835f6b7e5  tclsqlite.c
** 524c0e7ae58ec6e79b50b155390b0f8b26d04b3e  test_delete.c
** 8c461aea7275a4fdcda1c6aed17f01547b20cccb  test_delete.h
** 9a18048630e71a0834c4df1620fea44c30992f56  test_intarray.c
** ccb958e7d6b6effa2af64e4dc99a8a3a91785c54  test_intarray.h
** fffb4e2fb0ee47badf7cbbd480fc441940773ab0  test_multiplex.c
** 6f46d2d538fa54c01e1290e6846a91af52e4f030  test_multiplex.h
** 3c5eab5804727a1e0783e036fa719329b462b81b  zipvfs.c
** 26925927ee16972522ef379c6a5185ce0f30cd6e  zipvfs.h
*/
#ifndef _NDS_SQLITE_H
#define _NDS_SQLITE_H 1
#ifdef NDS_LONG_AND_LARGE_FILES
  #define NDS_LONG_FILENAMES 1
  #define NDS_LARGE_FILES 1
#endif
#ifndef NDS_LONG_FILENAMES
...
*/
#define SQLITE_NDSEV_DEVKIT_VERSION "3.46.0 2024-05-23 14:15:40 b34b88c759c0bb57"
/*
...
**
*/
#define SQLITE_NDSEV_DEVKIT 0xdba60a6c
#define SQLITE_NDSEV_DEVKIT_ID "dba60a6c999e89eeaf674654bbb5240adb44a1ab 3.46.0"
#ifndef SQLITE_API
...
#define SQLITE_SOURCE_ID      "2024-05-23 14:14:24 19716a4649f374c65f12a3279bdf0bb220b2ae0656dbe967362d34673e3a2be9"
...
*/
SQLITE_API int zipvfs_create_vfs(
  char const *zName,
  char const *zParent,
  void *pCtx,
...
SQLITE_API int zipvfs_create_vfs_v2(
  char const *zName,
  char const *zParent,
  void *pCtx,
  int (*xCompressBound)(void *, int nSrc),
...
*/
SQLITE_API int zipvfs_create_vfs_v3(
  char const *zName,
  char const *zParent,
  void *pCtx,
...
** are undefined.
*/
SQLITE_API void zipvfs_destroy_vfs(const char *zName);
...
*/
SQLITE_API const char *zipvfs_errmsg(int rc);
...
**
** ZIPVFS_CTRL_JOURNAL_POINTER:
**   For a ZipVFS database, this file-control is used to obtain a pointer
**   to the sqlite3_file object open on either the rollback journal or 
**   write-ahead log for a particular database, just as
**   SQLITE_FCNTL_JOURNAL_POINTER can be for a non-ZipVFS database. If
**   the database is not a ZipVFS database, invoking this file-control
**   returns SQLITE_NOTFOUND.
**
...
#define ZIPVFS_CTRL_JOURNAL_POINTER  230467
#define ZIPVFS_CTRL_CACHE_FLUSH      230468
...
*/
SQLITE_API int sqlite3_zipvfs_dictstore_register(sqlite3*);
...
*/
SQLITE_API int zipvfs_dictstore_get(
...
/*
** Flush any dirty pages belonging to any database attached to the db
** handle passed as the only argument that are not currently in use to
** disk. This is different from sqlite3_db_cacheflush() in that it 
** flushes pages all the way through any ZipVFS layer to disk.
*/
SQLITE_API int sqlite3_zipvfs_cacheflush(sqlite3 *db);
...
/*
** Delete the database file identified by the string argument passed to 
** this function. The string must contain a filename, not an SQLite URI.
**
** As well as the named database file, any files within the same directory
** that have filenames that could be used for journal or wal files 
** associated with the same database are also deleted. Furthermore, any
** files with filenames that may have been generated by the multiplexor
** module to extend any deleted database, wal or journal file are also
** deleted.
**
** If no error occurs, SQLITE_OK is returned. Or, if an OOM error occurs,
** SQLITE_NOMEM. If an error occurs within an OS call such as access()
** or unlink(), then SQLITE_ERROR is returned. In this case it is 
** guaranteed that sqlite3_delete_database() called no further system 
** calls after the error occurred. This means that the application may 
** still use OS specific methods (errno on UNIX or GetLastError() on 
** win32) to investigate the cause of the error.
*/
SQLITE_API int sqlite3_delete_database(const char *zFile);

#ifdef __cplusplus
}  /* end of the 'extern "C"' block */
#endif

/************** End of test_delete.h *****************************************/
/************** Begin file carray.h ******************************************/
/*
** 2020-11-17
**
